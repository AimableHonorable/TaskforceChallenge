...
ActiveRecord::Schema.define(version: 2020_01_11_202007) do
  ...
  create_table "breakfasts", force: :cascade do |t|
    ...
    t.index ["restaurant_id"], name: "index_breakfasts_on_restaurant_id"
  end
  ...
  add_foreign_key "breakfasts", "restaurants"
